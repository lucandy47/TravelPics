...
ECHO OFF
docker build -t travelpics-api-%environment%:%imageVersion% --build-arg Environment="Development"  --build-arg AppConfigConnectionString="Endpoint=https://travelpicsappconfiguration.azconfig.io;Id=/9U6-l0-s0:oHtG9HIFpsW3rua+iYCD;Secret=KcpyeMOfEhyp1/Uds6MXxzBvWl3Yj2SWPTtzvw7LRw8=" -f ./Dockerfile_api.dockerfile .
